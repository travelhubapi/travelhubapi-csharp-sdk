    ...
    public static class HotelMock
    {
        ...
        public static OAuthClient GetOAuthToGetCancellationPoliciesResponse(Settings settings)
        {
            ...
            Func<HttpContent, bool> httpRequestContentCheck = content =>
            {
                ...
                var getCancellationPoliciesRequestObj = getCancellationPoliciesRequestString.ToObject<TravelHubApi.Sdk.Hotel.V1.Models.Hotel>();
                var getCancellationPoliciesRequestExpectedObj = getCancellationPoliciesRequest.ToObject<TravelHubApi.Sdk.Hotel.V1.Models.Hotel>();
                try
                {
                    getCancellationPoliciesRequestObj.ShouldBeEquivalentTo<TravelHubApi.Sdk.Hotel.V1.Models.Hotel>(getCancellationPoliciesRequestExpectedObj);
                    return true;
                }
                catch
                {
        ...
        public static TravelHubApi.Sdk.Hotel.V1.Models.Hotel GetCancellationPoliciesRequest()
        {
            return GetCancellationPoliciesJSONRequest().ToObject<TravelHubApi.Sdk.Hotel.V1.Models.Hotel>();
        }
        #endregion
